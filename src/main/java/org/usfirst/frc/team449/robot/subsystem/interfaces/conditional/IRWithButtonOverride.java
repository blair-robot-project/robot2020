...
/**
 * A subsystem which returns true when either the IR sensor returns true or a manual override button is pressed.
 */
...
public class IRWithButtonOverride implements SubsystemConditional {
	 ...
	 */
	@NotNull
	private final MappedDigitalInput infraredSensor;
