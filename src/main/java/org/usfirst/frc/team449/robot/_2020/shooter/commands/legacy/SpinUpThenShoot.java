package org.usfirst.frc.team449.robot._2020.shooter.commands.legacy;
...
import org.usfirst.frc.team449.robot._2020.shooter.commands.SpinUpFlywheel;
import org.usfirst.frc.team449.robot._2020.shooter.commands.TurnAllOn;
...
public class SpinUpThenShoot<T extends Subsystem & SubsystemFlywheel> extends SequentialCommandGroup {
     ...
     */
    @JsonCreator
    public SpinUpThenShoot(@NotNull @JsonProperty(required = true) final T flywheel,
