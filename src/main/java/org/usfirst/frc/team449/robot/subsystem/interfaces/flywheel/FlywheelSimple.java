...
public class FlywheelSimple extends SubsystemBase implements SubsystemFlywheel, Loggable {
  ...
  public FlywheelSimple(
      @NotNull @JsonProperty(required = true) final SimpleMotor shooterMotor,
      @NotNull @JsonProperty(required = true) final SimpleMotor feederMotor,
      @JsonProperty(required = true) final double shooterVelocity,
      @Nullable final Double feederVelocity,
      final double spinUpTime) {
