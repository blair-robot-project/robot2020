...
/**
 * A mix-in for {@link edu.wpi.first.wpilibj2.command.CommandGroupBase} and its WPILib subclasses that annotates the
 * constructor for use with Jackson. Don't make subclasses of this.
 */
