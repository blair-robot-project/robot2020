...
public class LimelightDistanceComponentDiagonal implements DoubleSupplier {
  ...
  public LimelightDistanceComponentDiagonal(
      ...
      final double limelightAngleRight,
  ...
  public double getAsDouble() {
    final LimelightDistanceComponent distance = new LimelightDistanceComponent(limelight, limelightHeight, limelightAngleUp, targetHeight);
