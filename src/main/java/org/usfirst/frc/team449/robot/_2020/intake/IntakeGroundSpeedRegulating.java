...
public class IntakeGroundSpeedRegulating extends SubsystemBase implements SubsystemIntake, SubsystemAnalogMotor, Loggable {
  ...
  @Log.ToString
  @NotNull
  private SubsystemIntake.IntakeMode mode = IntakeMode.OFF;
  @NotNull
  private final Map<IntakeMode, Double> targetVelocities;
   ...
   */
  @JsonCreator
  public IntakeGroundSpeedRegulating(@NotNull @JsonProperty(required = true) final DriveUnidirectional drive,
