...
public class ScanThenTurn extends SequentialCommandGroup {
  ...
  @JsonCreator
  public ScanThenTurn(
      @JsonProperty(required = true) final int scannerPipe,
      @NotNull @JsonProperty(required = true) final UnidirectionalNavXDefaultDrive driveCommand,
      @NotNull @JsonProperty(required = true) final Command limelightCommand,
      @JsonProperty(required = true) final int driverPipe) {
    addCommands(
