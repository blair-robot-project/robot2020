...
public class SetAnalogMotorWithRequires <T extends Subsystem & SubsystemAnalogMotor> extends Command {
     ...
     */
    @JsonCreator
    public SetAnalogMotorWithRequires(@NotNull @JsonProperty(required = true) T subsystem,
