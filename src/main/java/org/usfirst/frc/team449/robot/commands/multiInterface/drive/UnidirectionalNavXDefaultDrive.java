...
public class UnidirectionalNavXDefaultDrive<T extends Subsystem & DriveUnidirectional & SubsystemAHRS> extends PIDAngleCommand implements Loggable {
    ...
    /**
     * A Debouncer so we only switch to driving straight when the conditions are met for a certain period of time.
     */
    @NotNull
    private final Debouncer driveStraightLoopEntryTimer;
    /**
