...
public class ScanThenTurn extends CommandBase implements Loggable {
   ...
   */
  @JsonCreator
  public ScanThenTurn(@JsonProperty(required = true) final int scannerPipe,
                      @NotNull @JsonProperty(required = true) final NavXTurnToAngleLimelight turnCommand,
                      @JsonProperty(required = true) final int driverPipe,
                      @JsonProperty(required = true) final Limelight limelight) {
