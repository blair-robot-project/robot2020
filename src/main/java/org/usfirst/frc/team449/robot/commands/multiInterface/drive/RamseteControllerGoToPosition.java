...
public class RamseteControllerGoToPosition extends CommandBase implements Loggable {
    ...
    @JsonCreator
    public RamseteControllerGoToPosition(@JsonProperty(required = true) DriveUnidirectionalWithGyro drivetrain,
        ...
        config = new TrajectoryConfig(maxSpeedMeters, maxAccelMeters)
    ...
    public void initialize() {
        wrappedCommand = new RamseteCommand(TrajectoryGenerator.generateTrajectory(drivetrain.getCurrentPose(), translations == null ? new ArrayList<>() : translations, endingPose, config),
