...
public class SubsystemPositionSimple extends SubsystemBase implements SubsystemPosition, Loggable {
   ...
   */
  @JsonCreator
  public SubsystemPositionSimple(@NotNull final SmartMotor motor, final double onTargetTolerance) {
    this.motor = motor;
    this.onTargetTolerance = onTargetTolerance;
  }

  @JsonCreator
  public static SubsystemPositionSimple create(
      @NotNull @JsonProperty(required = true) final MappedSparkMax spark,
      @JsonProperty(required = true) final double onTargetTolerance) {
    return new SubsystemPositionSimple(spark, onTargetTolerance);
  }
  ...
  public static SubsystemPositionSimple create(
      ...
      @JsonProperty(required = true) final double onTargetTolerance) {
    return new SubsystemPositionSimple(talon, onTargetTolerance);
  }
   ...
   */
  @Override
  public void setMotorOutput(final double output) {
