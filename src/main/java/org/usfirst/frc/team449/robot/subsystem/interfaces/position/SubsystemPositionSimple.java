...
/**
 * A simple SubsystemPosition that uses a {@link UPSTalon}.
 */
...
public class SubsystemPositionSimple extends SubsystemBase implements SubsystemPosition, Loggable {
     ...
     */
    @JsonCreator
    public SubsystemPositionSimple(@NotNull @JsonProperty(required = true) UPSTalon talon,
