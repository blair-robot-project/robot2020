...
/**
 * Mapped robot simulation configuration.
 */
public class SimulationConfig {
  ...
  public static class Settings {
     ...
     * @param replaceSimulationWithUnimplemented Whether to construct instances without
     * implementation that require minimal system resources.
     */
    @JsonCreator
