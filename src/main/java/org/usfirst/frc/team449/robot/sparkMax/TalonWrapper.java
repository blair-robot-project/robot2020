...
/**
 * Like FPSTalon, except it conforms to the new
 * inheritance stuff. Not sure how to deal with SlaveTalon and stuff
 * TODO move this out of sparkMax
 */
public class TalonWrapper extends SmartMotorBase {
    ...
    /**
     * Default for postEncoderGearing if it's null
     */
    protected static final Double POST_ENCODER_GEARING_DEFAULT = 1.;
     ...
     */
    @JsonCreator
    public TalonWrapper(@JsonProperty(required = true) int port,
        ...
        this.postEncoderGearing = postEncoderGearing != null ? postEncoderGearing : POST_ENCODER_GEARING_DEFAULT;
    ...
    public void setGearScaledVelocity(double velocity, int gear) {
        if (currentGearSettings.getMaxSpeed() == null) {
            ...
            var gearSettings = perGearSettings.get(gear);
            if (gearSettings.getMaxSpeed() != null) {
                setVelocityFPS(gearSettings.getMaxSpeed() * velocity);
            } else {
                setPercentVoltage(velocity);
            }
        }
