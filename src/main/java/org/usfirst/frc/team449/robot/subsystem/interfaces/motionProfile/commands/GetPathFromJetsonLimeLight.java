...
public class GetPathFromJetsonLimeLight extends Command implements PoseCommand {
    ...
    /**
     * The points for the path to hit. Generated by the x, y, and theta suppliers. Null to use lambdas
     */
    @Nullable
    ...
    /**
     * The supplier for the x distance to travel, in feet
     */
    @NotNull
    private final DoubleSupplier xSupplier;
    /**
     * The supplier for the y distance to travel, in feet
     */
    @NotNull
    private final DoubleSupplier ySupplier;
    /**
     * The supplier for the angle from the LimeLight, in degrees. Referenced as "yaw" in LimeLightComponent
     */
    @NotNull
     ...
     */
    @JsonCreator
    public GetPathFromJetsonLimeLight(@NotNull @JsonProperty(required = true) PathRequester pathRequester,
                                      ...
                                      @NotNull @JsonProperty(required = true) DoubleSupplier xSupplier,
                                      @NotNull @JsonProperty(required = true) DoubleSupplier ySupplier,
                                      @NotNull @JsonProperty(required = true) DoubleSupplier thetaSupplier) {
        ...
        //The only waypoint we're using is the suppliers because we want to drive to a vision target
        this.waypoints = new Waypoint[1];
        Waypoint waypoint = new Waypoint(xSupplier.getAsDouble(), ySupplier.getAsDouble(), thetaSupplier.getAsDouble());
