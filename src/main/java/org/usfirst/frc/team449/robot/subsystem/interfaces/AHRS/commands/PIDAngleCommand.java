...
public abstract class PIDAngleCommand extends CommandBase implements Loggable {
  ...
  protected double getOutput() {
    return computeOutput(getRawOutput());
  }

  protected double getOutputHardcoded(final double setpoint) {
    return computeOutput(pidController.calculate(subsystem.getHeadingCached(), setpoint));
  }

  protected double computeOutput(double controllerOutput) {
