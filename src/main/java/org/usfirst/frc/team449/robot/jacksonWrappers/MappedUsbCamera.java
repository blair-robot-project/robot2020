...
public class MappedUsbCamera extends UsbCamera {
  ...
  public MappedUsbCamera(
      @NotNull @JsonProperty(required = true) final String name,
      @JsonProperty(required = true) final int devAddress,
      @JsonProperty(required = true) final int width,
      @JsonProperty(required = true) final int height,
      @JsonProperty(required = true) final int fps) {
