...
public class LoadProfileTwoSides<T extends Subsystem & SubsystemMPTwoSides> extends InstantCommand {
     ...
     */
    @JsonCreator
    public LoadProfileTwoSides(@NotNull @JsonProperty(required = true) T subsystem,
