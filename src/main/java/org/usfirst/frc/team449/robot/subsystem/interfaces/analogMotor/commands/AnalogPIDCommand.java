...
public class AnalogPIDCommand<T extends Subsystem & SubsystemAnalogMotor> extends CommandBase {
  ...
  public AnalogPIDCommand(
      ...
      @NotNull @JsonProperty(required = true) final DoubleSupplier processVariableSupplier,
      @Nullable final DoubleSupplier setpointSupplier) {
    // Set P, I and D
    this.pidController =
        new PIDController(
   ...
   * edu.wpi.first.wpilibj.controller.PIDController}'s onTarget.
   *
  ...
  protected double returnPIDInput() {
    final double value = processVariableSupplier.getAsDouble();
