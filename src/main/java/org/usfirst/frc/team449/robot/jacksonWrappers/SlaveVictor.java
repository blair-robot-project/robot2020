...
public class SlaveVictor implements SlaveMotor {
     ...
     */
    @JsonCreator
    public SlaveVictor(@JsonProperty(required = true) final int port,
     ...
     */
    public void setMaster(@NotNull final IMotorController toFollow, final boolean brakeMode, @Nullable final Integer voltageCompSamples) {
