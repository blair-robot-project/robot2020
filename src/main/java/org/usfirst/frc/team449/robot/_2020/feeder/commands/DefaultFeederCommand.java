...
public class DefaultFeederCommand extends CommandBase implements Loggable {
  ...
  @Log.Exclude @NotNull private final ConditionTimingComponentDecorator sensor2;
   ...
   * @param runMode the {@link
   *     org.usfirst.frc.team449.robot._2020.multiSubsystem.SubsystemIntake.IntakeMode} to run the
   *     feeder at when
