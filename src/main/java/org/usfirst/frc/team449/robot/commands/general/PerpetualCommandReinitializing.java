...
public class PerpetualCommandReinitializing extends PerpetualCommand {
     ...
     */
    @JsonCreator
    public PerpetualCommandReinitializing(@NotNull @JsonProperty(required = true) final Command command,
                                          @Nullable final Subsystem[] requiredSubsystems) {
        // TODO: We should requireNonNull all @Nullable parameters because map errors can cause them to be null and result in weird Jackson exceptions.
        super(command);
